...
begin
//showmessage('Dikkat Hata Var !'+#13+'* Þifreli Tablo Ýçeriði Algoritmayla uyumsýz Olabilir !'+#13+'* Sifreli Tablonun Þifrelenmiþ Bölümü Seçilmemiþ Olabilir !'+#13+'* Þifre Algoritmasý Firma Tarafýndan Deðiþtirilmiþ Olabilir !'+#13+'Program Kapatýlacak !');
//halt;
cevir:=0;
exit;
end else
...
suibutton2.Enabled:=false;
   ...
   if (MessageDlg('Eþleþtirilen Bölümler KDV SÝZ iþlensin mi?',mtConfirmation,[mbYes,mbNo],0))=mrYes then
   begin
...
san:=san2-san;
  ...
  button1.caption:=button1.Caption+inttostr(san)+' Saniyede Algoritma Çözme Tamalandý.Çýkýþ için týkla ..';
         panel1.Visible:=true;
         button1.Visible:=true;
         form1.Caption:=form1.Caption+' Kayýt Çözüldü.. Ýþlem bitti !';
...
end Else Showmessage('Hata !!'+#13+'Çözülmesini istadiðiniz Dosyanýn Kopyasý Alýnamadý');
...
begin
sure:=sure+1;
form1.Caption:=form1.Caption+'Geçen Zaman : '+inttostr(sure);
end;
